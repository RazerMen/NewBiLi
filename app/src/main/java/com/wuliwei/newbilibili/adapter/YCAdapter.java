...
public class YCAdapter extends BaseAdapter {
    private final Context mContext;
    private final List<YCBean.DataBean> datas;

    public YCAdapter(Context context, List<YCBean.DataBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        YCBean.DataBean dataBean = datas.get(position);
